...
const Profile = () => {
  ...
  const userEmail = localStorage.getItem("email");
    ...
    return (
    <div className="max-w-4xl mx-auto bg-white border border-black/30  shadow-lg rounded-xl p-8 mt-8">
        <h2 className="text-3xl font-bold text-gray-800 mb-6 pb-3">👤 Profile Details</h2>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-gray-50 p-4 rounded-lg border-1  shadow-md">
            ...
            <div className="sm:col-span-2 bg-gray-50 p-4 rounded-lg border-1 shadow-md">

  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className='text-black text-center'>
        <div className='text-3xl text-purple-700 font-bold text-decoration-line: underline py-5'> Register </div>
        <UserType userType = {userType}   setUserType = {setUserType} className=''/>
      </div>
